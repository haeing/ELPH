...
BACDetectorConstruction_167_3::BACDetectorConstruction_167_3()
...
G4VPhysicalVolume* BACDetectorConstruction_167_3::Construct()
{
  ...
  new G4PVPlacement(0,G4ThreeVector(Aerox/2,0*mm,Aeroz),Aero_airLW,"Aero_air",ReflectLW,false,10,checkOverlaps);
  new G4PVPlacement(0,G4ThreeVector(-Aerox/2,0*mm,Aeroz),Aero_airLW,"Aero_air",ReflectLW,false,20,checkOverlaps);
  new G4PVPlacement(0,G4ThreeVector(Aerox/2+5*mm,0*mm,-Aeroz),Aero_airLW,"Aero_air",ReflectLW,false,30,checkOverlaps);
  new G4PVPlacement(0,G4ThreeVector(-Aerox/2+5*mm,0*mm,-Aeroz),Aero_airLW,"Aero_air",ReflectLW,false,40,checkOverlaps);
  new G4PVPlacement(0,G4ThreeVector(Aerox/2+5*mm,0*mm,0),Aero_airLW,"Aero_air",ReflectLW,false,30,checkOverlaps);
  new G4PVPlacement(0,G4ThreeVector(-Aerox/2+5*mm,0*mm,0),Aero_airLW,"Aero_air",ReflectLW,false,40,checkOverlaps);
...
void BACDetectorConstruction_167_3::ConstructSDandField()
{
