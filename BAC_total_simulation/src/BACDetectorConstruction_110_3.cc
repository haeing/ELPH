...
BACDetectorConstruction_110_3::BACDetectorConstruction_110_3()
...
G4VPhysicalVolume* BACDetectorConstruction_110_3::Construct()
{
  ...
  G4double Aerox_real = 125 *mm;
  G4double Aeroy_real = 125 *mm;
...
void BACDetectorConstruction_110_3::ConstructSDandField()
{
