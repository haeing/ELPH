...
int main(int argc,char** argv)
{
  ...
  */
  ...
  if(geo_version ==1)runManager->SetUserInitialization(new BACDetectorConstruction_167_2());
  else if(geo_version ==2)runManager->SetUserInitialization(new BACDetectorConstruction_167_3());
  else if(geo_version ==3)runManager->SetUserInitialization(new BACDetectorConstruction_110_3());
  else if(geo_version ==4)runManager->SetUserInitialization(new BACDetectorConstruction_110_3_par());
